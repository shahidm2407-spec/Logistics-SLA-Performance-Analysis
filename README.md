...
This project simulates a transportation network database and analyzes delivery performance using SQL. The objective is to measure Service Level Agreement (SLA) performance, identify delay drivers, and evaluate operational efficiency across carriers, regions, and time.
